 ...
 *
 * These objects will usually be one per pbSprite, but can be shared safely if a large number of pbSprite
 * objects will animate entirely in sync (or not at all).
 * Be careful not to update the cellFrame in every pbSprite that shares it though!
 *
 */
